...
struct QuizView: View {
    ...
    let quizItems: [QuizItem] = [
        ...
        QuizItem(question: "地球の衛星はどれ？",options: ["月", "火星", "金星"],correctAnswerIndex: 0),

        QuizItem(question: "YouTubeを運営している企業はどこ？",options: ["Meta", "Google", "Amazon"],correctAnswerIndex: 1),

        QuizItem(question: "日本の首都はどこ？",options: ["大阪", "名古屋", "東京"],correctAnswerIndex: 2),

        QuizItem(question: "SwiftUIを開発している企業はどこ？",options: ["Apple", "Microsoft", "Adobe"],correctAnswerIndex: 0)
    ]
